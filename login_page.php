...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $roleConfig = [
        ...
        'PRO_BONO_LAWYER' => ['table' => 'pro_bono_lawyer', 'redirect' => 'pro_bono_lawyer_dashboard.php'],
    ...
    if ($result && $result->num_rows === 1) {
        ...
        if (password_verify($password, $user['password'])) {
            ...
            $_SESSION['user_id'] = $user['user_id'] ?? $user['id'] ?? $user['prisoner_id'] ?? $user['warden_id'] ?? null;
